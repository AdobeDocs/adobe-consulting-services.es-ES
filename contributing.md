...
Gracias por contribuir a la documentación de los servicios de consultoría de Adobe. Agradecemos las contribuciones de contenido de toda nuestra comunidad de lectores, así como de otros empleados del Adobe.
...
Si bien acogemos con beneplácito cualquier contribución para mejorar la documentación de AEM, pedimos que las contribuciones se ajusten a determinadas directrices y normas, siempre que sea posible. Consulte la [Directrices para contribuir a la documentación de ACS](guidelines.md) para obtener más información.
