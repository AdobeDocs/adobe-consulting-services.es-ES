...
>[!IMPORTANT]
>
>Esta capacidad no está disponible de forma predeterminada como parte del producto. La implementación requiere un contrato de mantenimiento de Adobe Consulting. Póngase en contacto con su representante de Adobe para obtener más información.
>
...
1. Aprobación de contenido: cuando se ha creado contenido nuevo o se ha editado el contenido existente en AEM, el contenido debe aprobarse para su uso en VPM que admita el proceso de aprobación médico, legal y normativo (MLR) de las ciencias biológicas.
1. Administración de contenido: proporcione visibilidad sobre la utilización de los recursos al establecer relaciones en PromoMats entre las tácticas digitales (por ejemplo, correo electrónico, presentaciones, sitios web) y sus elementos (por ejemplo, logotipos, fotografías, gráficos) creados en AEM para documentos originados en AEM.

Los beneficios incluyen:

* Mantener una única fuente fiable para los recursos y el contenido sin duplicaciones en repositorios digitales.
* Aprovechamiento de Veeva Vault para la administración de derechos y conformidad y de AEM para la mejor creación/entrega de contenido y recursos de su clase.
* Ayuda a automatizar la transferencia de contenido y metadatos entre AEM y Veeva Vault.
...
* Admite el envío de páginas del sitio de AEM, Assets, fragmentos de contenido y fragmentos de experiencias a VPM. Las páginas de AEM, los fragmentos de contenido y los fragmentos de experiencias se pueden enviar como PDF o imágenes de captura de pantalla. Los binarios de los AEM Assets se envían tal cual.
* Admite la sincronización manual y automatizada de elementos de metadatos seleccionados que se pueden configurar desde AEM a VPM.
* Admite la sincronización manual y automatizada de elementos de metadatos seleccionados que se pueden configurar desde VPM a AEM.
* Admite relaciones entre páginas de sitio de AEM, Assets, fragmentos de contenido y fragmentos de experiencias en VPM para automatizar relaciones de contenido.
...
* No replica los procesos y la funcionalidad de AEM en Veeva o viceversa.
* No hace MLR por sí solo. Ayuda a la automatización del envío de contenido a Veeva donde se produce la RLM.
* No debe utilizarse para crear una configuración idéntica entre AEM y Veeva. No es necesario mover todo el contenido entre las dos plataformas.


>[!IMPORTANT]
>
>Actualmente, esta integración considera AEM como la fuente fiable para la sincronización de contenido.
...
* **URL de instancia de AEM**: `Place the Adobe Experience Manager instance url here.`
